    ...
    <div className="loginPage">
      ...
      <div className="loginImage">
        <div className="loginImageCard">
          <Image
            src="/assets/login.jpg" // Path to the image in public/assets/
            alt="Login Illustration"
            width={400} // Adjust width based on your image
            height={400} // Adjust height based on your image
            priority // Optional: Load eagerly for above-the-fold content
          />
        </div>
      </div>
